...
Only the **hand-drawn key-concept diagrams** from `assets/key-concepts/`. These are the beginner sketches that sit beside the written notes - not the workshop slides, and not the redrawn generated diagrams.

Ordered by the same learning path as the [README](README.md). Each diagram has a short context write-up so you can study from this page alone.

Other galleries (kept separate on purpose):

- [Generated diagrams](IMAGE_GALLERY.md) - cleaner redraws of the important workshop slides
- [Workshop slides](SLIDES_GALLERY.md) - original ppt screenshots

| Level | Difficulty | Topic | Diagrams |
|---:|---|---|---:|
| 0 | Basic | [Foundations](topics/00-foundations.md) | 1 |
| 1 | Basic | [Roman and the GBTDS](topics/01-roman-and-gbtds.md) | 1 |
| 2 | Basic | [Planet formation and populations](topics/02-planet-formation-and-populations.md) | 1 |
| 3 | Intermediate | [Microlensing fundamentals](topics/03-microlensing-fundamentals.md) | 2 |
| 4 | Advanced | [Advanced microlensing and yields](topics/04-advanced-microlensing-and-yields.md) | 4 |
| 5 | Intermediate | [Transits](topics/05-transits.md) | 2 |
| 6 | Intermediate | [Galactic context and dust](topics/06-galactic-context-and-dust.md) | 1 |
| 7 | Advanced | [Occurrence rates](topics/07-occurrence-rates.md) | 1 |
| 8 | Advanced | [Pipelines and host stars](topics/08-pipelines.md) | 2 |
| 9 | Advanced | [Follow-up and future missions](topics/09-follow-up-and-future.md) | 1 |
| 10 | Wrap-up | [Hands-on roadmap](topics/10-hands-on-and-resources.md) | 1 |

---

## Level 0 - Foundations (Basic)
...
## Level 2 - Planet formation and populations (Basic)
...
## Level 7 - Occurrence rates (Advanced)
...
## Level 9 - Follow-up and future missions (Advanced)
